...
export function SubmitButton({
  ...
  return (
    <button
      ...
      autoFocus={focus}
      className={cn(
        "border-submit-button-border focus:ring-focus mb-1 flex items-center justify-center border leading-4 uppercase shadow-xs focus:ring-2 focus:ring-offset-2 focus:outline-hidden enabled:hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60",
        "button-custom"
      )}
      style={{
